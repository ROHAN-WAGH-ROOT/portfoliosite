  ...
  return (
    <div>
      <div className={styles.homeContainer}>
        <div className={styles.containerOfNavAndImage}>
          <motion.div className={styles.image}>
            {/* <img src={Success} alt="Image" draggable={'false'} /> */}
            ...
            >
              ...
              <motion.ellipse
                ...
                rx="58.9"
                ry="1.6"
                transform="rotate(87.78 745.806 351.844) scale(.99995)"
              ></motion.ellipse>
              <motion.path
                variant={pathVarients}
                initial={pathVarients.hidden}
              ...
              <motion.path
                ...
                stroke="#000"
                stroke-miterlimit="10"
                d="M749.3 469.3c-.3-.3 1-2 2.5-5s3.1-7.4 3.1-12.4-1.5-9.4-3-12.4-2.8-4.7-2.5-5.1c.3-.3 2.3.9 4.5 3.9 2.2 2.9 4.3 7.8 4.3 13.6s-2.2 10.7-4.4 13.6c-2.2 3-4.2 4.1-4.5 3.8zM746.8 469.4c.3.3 0 1.5-1.6 2.6-.8.6-1.8 1-3.1 1.3-1.3.2-2.7.2-4.2-.3-1.4-.5-2.6-1.4-3.4-2.4-.8-1-1.3-2-1.6-2.9-.5-1.9 0-3 .4-3 .5 0 .9.9 1.7 2.1.8 1.2 2.2 2.5 4 3.2 1.8.7 3.8.5 5.1.1 1.4-.5 2.3-1 2.7-.7z"
              ></motion.path>
              <motion.path
                variant={pathVarients}
                initial={pathVarients.hidden}
                ...
                stroke="#000"
                stroke-miterlimit="10"
                d="M749.5 466.3c-.3.4-1.5 0-3.3-.8-1.8-.7-4.1-1.8-6.7-2.1-1.3-.2-2.5-.1-3.6.1-.5.1-1 .3-1.5.5l-.6.3c-.2.1-.3.2-.5.3-.6.5-.9.9-1 1.3-.1.4 0 .7-.2.9-.2.1-.7.1-1-.6-.2-.3-.3-.9-.2-1.4.1-.5.3-1.1.6-1.6.2-.3.4-.5.6-.8.2-.3.6-.5.8-.7.6-.4 1.2-.7 1.9-1 1.4-.5 3.1-.7 4.8-.5 3.5.4 6 2.1 7.6 3.4 1.8 1.3 2.5 2.3 2.3 2.7z"
              ></motion.path>
              <motion.path
                variant={pathVarients}
                initial={pathVarients.hidden}
                ...
                stroke="#000"
                stroke-miterlimit="10"
                d="M753.1 458c-.3.4-2-.4-4.5-1.7-2.6-1.2-6.1-3-10-2.9-2 .1-3.7.6-5.1 1.5-1.4.9-2.2 2.1-2.5 3.1-.3 1 0 2 .3 2.7.3.6.6 1 .5 1.2-.1.2-.7.3-1.5-.3s-1.7-1.9-1.6-3.8c.1-1.9 1.2-3.9 3-5.2 1.8-1.4 4.2-2.2 6.7-2.3 2.5-.1 4.9.5 6.8 1.4 1.9.8 3.4 1.9 4.6 2.8 2.4 1.7 3.5 3.1 3.3 3.5z"
              ></motion.path>
              <motion.path
                variant={pathVarients}
                initial={pathVarients.hidden}
              ...
              <motion.path
                ...
                stroke="#000"
                stroke-miterlimit="10"
                d="M891 835.7c-.5-.1-.2-2.5-.2-6.2s-.6-8.8-2-14.3-3.3-10.3-4.6-13.9c-1.3-3.6-1.9-5.9-1.5-6.1.4-.2 1.8 1.8 3.6 5.1 1.8 3.4 4.1 8.2 5.6 14 1.5 5.8 1.7 11.3 1.2 15.2-.6 4.1-1.7 6.3-2.1 6.2zM885.9 842.2c-.9.1-2.1-5.3-4-11.7-1.9-6.4-3.7-11.6-2.9-12 .8-.4 4.1 4.3 6 11.1 2 6.7 1.8 12.5.9 12.6z"
              ></motion.path>
              <motion.path
                variant={pathVarients}
                initial={pathVarients.hidden}
              ...
              <motion.ellipse
                ...
                rx="4.3"
                ry="1.6"
                transform="rotate(81.616 821.878 832.454)"
              ></motion.ellipse>
              <motion.ellipse
                variant={pathVarients}
                initial={pathVarients.hidden}
                ...
                rx="5.4"
                ry="1.6"
                transform="rotate(83.483 826.043 857.621)"
              ></motion.ellipse>
              <motion.path
                variant={pathVarients}
                initial={pathVarients.hidden}
                ...
                stroke="#000"
                stroke-miterlimit="10"
                d="M830.1 889.1c-.9 0-1.7-2.4-2.1-5.3-.4-3-.3-5.5.6-5.7.9-.2 2.2 2.1 2.6 5.3.4 3.1-.2 5.7-1.1 5.7z"
              ></motion.path>
              <motion.ellipse
                variant={pathVarients}
                initial={pathVarients.hidden}
                ...
                rx="4.3"
                ry="1.6"
                transform="rotate(80.213 834.553 904.452)"
              ></motion.ellipse>
              <motion.ellipse
                variant={pathVarients}
                initial={pathVarients.hidden}
                ...
                rx="3.8"
                ry="1.6"
                transform="rotate(80.096 839.135 929.795)"
              ></motion.ellipse>
              <motion.path
                variant={pathVarients}
                initial={pathVarients.hidden}
              ...
              <motion.ellipse
                ...
                rx="8.3"
                ry="1.6"
                transform="rotate(-83.062 695.118 969.79)"
              ></motion.ellipse>
              <motion.path
                variant={pathVarients}
                initial={pathVarients.hidden}
              ...
              <motion.path
                ...
                stroke="#000"
                stroke-miterlimit="10"
                d="M882.5 566.6c-.4-.1-.7-.8-.5-1.7.1-1 .7-2.2 1.7-3.2s2.3-1.6 3.2-1.7c1-.1 1.6.1 1.7.6.1.4-.2 1-.7 1.5-.5.6-1.2 1.2-1.9 1.9s-1.4 1.4-2 1.9c-.5.4-1 .8-1.5.7z"
              ></motion.path>
              <motion.path
                variant={pathVarients}
                initial={pathVarients.hidden}
              ...
              <motion.path
                ...
                stroke="#000"
                stroke-miterlimit="10"
                d="M856.6 610.3c.1 0 .2.2.2.5.1.4 0 .9-.1 1.5-.2 1.3-1.1 3.2-2.8 4.9-1.8 1.7-4.5 3.2-7.8 3.4-3.3.3-6.9-.9-9.9-3.1s-5.1-5.1-6.5-7.9c-1.4-2.8-2.1-5.5-2.5-7.7-.8-4.5-.7-7.3-.3-7.3.5-.1 1.2 2.6 2.5 6.7.7 2.1 1.6 4.5 2.9 6.9 1.3 2.4 3.2 4.8 5.7 6.6 2.5 1.8 5.3 2.8 7.9 2.8 2.5-.1 4.8-1 6.4-2.2 1.6-1.2 2.6-2.5 3.1-3.6.7-.9.9-1.6 1.2-1.5z"
              ></motion.path>
              <motion.path
                variant={pathVarients}
                initial={pathVarients.hidden}
              ...
              <motion.ellipse
                ...
                rx="3.7"
                ry="1.6"
                transform="rotate(-55.342 861.62 539.05)"
              ></motion.ellipse>
              <motion.path
                variant={pathVarients}
                initial={pathVarients.hidden}
          ...
          >
            <div className={styles.linkContainer}>
              <NavLink className={styles.mainLink} to="/about">
                About
              </NavLink>
            </div>
            <div className={styles.linkContainer}>
              <NavLink className={styles.mainLink} to="/work">
                Work
              </NavLink>
            </div>
            <div className={styles.linkContainer}>
              <NavLink className={styles.mainLink} to="/contact">
                Contact
              </NavLink>
            </div>
            {/* <Loader /> */}
